...
export const DashboardSidebar = () => {
  ...
  return (
    <div className="flex">
      <SidebarProvider>
        <Sidebar className="w-[80px] shrink-0 border-r border-zinc-800 md:w-[90px]">
          <SidebarHeader className="flex w-full flex-col items-center justify-center space-y-3 bg-(--background-color) p-3">
          ...
          <SidebarContent className="flex w-full flex-col bg-(--background-color)">
            <SidebarGroup>
      ...
      <main className="ml-[80px] flex-1 md:ml-[90px]">
